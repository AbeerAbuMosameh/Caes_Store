...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('addPage')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="row">
                    @include('admin._msg')
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="basicInput11"
                                   placeholder="Enter Title" value=""  name="name" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="basicInput11"
                                   placeholder="Enter Title" value=""  name="title" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="basicInput11"
                                   placeholder="Enter Title" value=""  name="link" />
                        </div>
                    </div>
                    ...
                    <div  class="col-12">
                        <button type="submit" onclick="MyFun()" class="btn btn-primary mt-1">Submit</button>
