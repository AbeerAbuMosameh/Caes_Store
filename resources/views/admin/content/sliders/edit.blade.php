        ...
        <div class="card-body">
            <div class="tab-content">
                <div class="tab-pane active" id="slider" aria-labelledby="slider-tab" role="tabpanel">
                    <form action="" method="POST" action="{{route('sliders.update',$slider->id)}}">
                        @csrf
                        @method('put')
                        <div class="row">
                            @include('admin._msg')
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$slider->title}}" class="form-control" id="basicInput1"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="basicInput2" placeholder="Enter Title"
                                           name="service_title"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="basicInput4" placeholder="Enter Price"
                                           name="service_price"/>
                                </div>
                            </div>
                            <div class="col-12">
